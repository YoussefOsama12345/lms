...
const courseSchema = joi.object({
  title: joi.string()
    ...
    .messages({
      ...
      'string.pattern.base': 'Title can only contain letters, numbers, spaces, and these symbols: - _ \' "',
  ...
  description: joi.string()
    ...
    .messages({
      ...
      'string.pattern.base': 'Description contains invalid characters. Only letters, numbers, punctuation, and basic symbols are allowed.',
